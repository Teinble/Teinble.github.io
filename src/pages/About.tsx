		...
		<AboutContainer $nightMode={nightMode}>
			<ContentContainer>
				...
				<Section>
					...
					<p>
						I was born in Beijing, China. I came to Canada to pursue my studies
						in 2019.
					</p>
				...
				<Section>
					...
					<EducationItem>
						...
						<Program>
							Master of Applied Science in Computer Science (Sep 2025 - July
							2027)
						</Program>
						<Program>
							Honours Bachelor of Science in Computer Science (Sep 2021 - June
							2025){" "}
						</Program>
						<Detail>cGPA: 3.94/4.00</Detail>
						<Detail>Achievements: Dean's List Scholar x 4</Detail>
						<Detail>
							Courses Taken: Natural Language Processing, Operating System,
							Neural Nets and Deep Learning, Computer Networks, Algorithm Design
							& Analysis, Software Engineering, Introduction to Databases, and
							more.
						</Detail>
					</EducationItem>
				</Section>
				...
				<Section>
					...
					<WorkItem $nightMode={nightMode}>
						...
						<WorkDescription>
							<WorkListItem>
								Engineered the development of the IoT department's first Large
								Language Model (LLM) evaluation system, adopted by a team over
								10 engineers, integrating <strong>DeepEval</strong> for metrics
								collection and <strong>LangChain</strong> for judging and
								testing model encapsulation to evaluate Retrieval-Augmented
								Generation (RAG) models
							</WorkListItem>
							<WorkListItem>
								Generated and evaluated <strong>5,000</strong> test cases from
								official IoT developer platform documentations to assess RAG
								system performance across six dimensions
							</WorkListItem>
						</WorkDescription>
					</WorkItem>
				...
				<Section>
					...
					<InterestSection>
						...
						<InterestParagraph>
							While transformer models like <Highlight>ChatGPT</Highlight> have
							significantly advanced NLP, barriers such as high computational
							costs and limited resources still prevent underfunded enterprises
							from leveraging these technologies. I'm passionate about making
							NLP technologies more <Highlight>efficient</Highlight> and{" "}
							<Highlight>scalable</Highlight> to facilitate their widespread
							adoption.
						</InterestParagraph>
					</InterestSection>
				...
				<Section>
					...
					<List>
						...
						<ListItem>
							📺 Watching TV Shows (Better Call Saul is my favorite!)
						</ListItem>
